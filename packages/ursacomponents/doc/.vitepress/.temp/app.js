import { ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrRenderVNode, ssrRenderClass, ssrRenderTeleport, renderToString } from "vue/server-renderer";
...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"Ursa Components","description":"Ursa Vue 3 通用组件库文档","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"指南","link":"/guide/getting-started"},{"text":"组件","link":"/components/overview"}],"sidebar":[{"text":"开始","items":[{"text":"快速开始","link":"/guide/getting-started"}]},{"text":"组件","items":[{"text":"组件总览","link":"/components/overview"},{"text":"组件","collapsed":false,"items":[{"text":"UrsaMenu","link":"/components/UrsaMenu/UrsaMenu"},{"text":"UrsaTagsView","link":"/components/UrsaTagsView/UrsaTagsView"},{"text":"UrsaSearch","link":"/components/UrsaSearch/UrsaSearch"},{"text":"UrsaNavBar","link":"/components/UrsaNavBar/UrsaNavBar"}]},{"text":"路由","collapsed":false,"items":[{"text":"动态路由","link":"/router/dynamic-routes"}]}]}],"socialLinks":[]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><img${ssrRenderAttr("src", __props.src)}${ssrRenderAttr("alt", __props.alt)} class="${ssrRenderClass(["image-preview-trigger", __props.imgClass])}" data-v-e1465eee>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          _push2(`<div class="image-preview-mask" data-v-e1465eee><img${ssrRenderAttr("src", __props.src)}${ssrRenderAttr("alt", __props.alt)} class="image-preview-full" data-v-e1465eee></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/ImagePreview.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ImagePreview = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e1465eee"]]);
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
    app.use(ElementPlus);
